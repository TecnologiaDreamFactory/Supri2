 ...
 *
 * Export: uma única chamada a `exportBatchWorkbook` após métricas de estágio (parse…revisão); o workbook
 * aplica tempos finais (incl. duração do export) nos metadados (aba Condições Gerais) antes de gravar — evita IO duplicado.
 */
