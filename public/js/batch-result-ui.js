...
(function (global) {
  ...
  function renderDownloadFab(data) {
    ...
    if (!href) {
      return '<p class="batch-muted" style="pointer-events:auto;text-align:right;max-width:220px;margin:0;">Link de download não disponível.</p>';
    }
    return (
  ...
  /** Só o bloco de download (XLSX) — usado quando o dashboard completo está oculto. opts.variant "fab" = botão circular sobre a animação. */
